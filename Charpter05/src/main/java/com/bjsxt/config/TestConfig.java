...
import com.bjsxt.utils.DatabaseUtil;
import lombok.Data;
...
//        String subject = MimeUtility.encodeWord("ehr-测试报告", "gb2312", "B");
        mes.setSubject("ehr_testreport");//主题
        //设置邮件内容
        // mes.setContent("你好啊，大家", "text/html;charset=UTF-8");
        Multipart multipart = new MimeMultipart();
        // 设置邮件的文本内容
        BodyPart contentPart = new MimeBodyPart();
        contentPart.setText("Hello,this is the testreport");
